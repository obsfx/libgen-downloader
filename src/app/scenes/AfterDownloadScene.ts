...
import { AfterDownloadSceneOptions } from '../action-templates';

export default abstract class AfterDownloadScene extends Scene {
    ...
    public static show(x: number, y: number, message: string, showDIR: boolean = false): void {
        ...
        let listings: UITypes.Listing[] = AfterDownloadSceneOptions.map(
        ...
        EventHandler.attachResizeReRenderEvent(0, 'AfterDownloadScene', this.onResize.bind(this));
    ...
    public static hide(): void {
        ...
        EventHandler.detachResizeReRenderEventMap(0, 'AfterDownloadScene');
